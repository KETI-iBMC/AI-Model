...
{
	printf("\n=============================================================================\n");
	printf("\tUsage:  hid_gadget_test devname mouse|keyboard|joystick  [inputFile N]\n\n");
	printf("\tOption: inputFile N:\n");
	printf("\t\tinputFile - keyboard or mouse values (max 64 values) separated by newline.\n");
	printf("\t\tN    - times to run the values, 0 - run it till you stop this test\n");
	printf("\t\te.g:\n");
